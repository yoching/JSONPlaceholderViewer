...
//            andPredicateWithSubpredicates: [defaultPredicate, predicate]
//        )
//    }
...
extension Managed where Self: NSManagedObject {
    ...
    public static func count(
        ...
        let request = NSFetchRequest<Self>(entityName: entityName)
        configure(request)
        return try! context.count(for: request) //swiftlint:disable:this force_try
    }
...
extension Managed where Self: NSManagedObject {
    public static func fetchSingleObject(
        in context: NSManagedObjectContext,
        cacheKey: String,
    ...
    fileprivate static func fetchSingleObject(
        in context: NSManagedObjectContext,
        configure: (NSFetchRequest<Self>) -> Void
        ) -> Self? {
